...
class Warrior(Class):
    sword_timelimit = 1.5
    def __init__(self, name, score, level=1, ms=8, dmg=10, hp=100):
        self.sword_angle = 0
...
class Wizzard(Class):
    def __init__(self, name, score, level=1, ms=4, dmg=20, hp=50):
        self.magic_cd = 1
        self.magic_timer = 0
        self.magic_missiles = []
...
class Missile:
    """
    klasa pomocnicza do obslugi pocisków Wizzarda
    """
